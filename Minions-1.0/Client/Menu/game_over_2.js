 ...
 */
/*
 наше Окно выиграл 2 игрок
 */
 
 var Game_Over_2 = function(Game) {
    this.game = Game;
    this.image = new Image();
	this.image.src = "Images/Menu/game_over_2.png";
...
// обновление меню
Game_Over_2.prototype.update = function(Inputhandler) {
...
// отрисовка меню
Game_Over_2.prototype.draw = function(screen) {
	...
	screen.drawImage(this.image, this.game.gameSize.width / 2 - this.image.width / 2 / 1.1, this.game.gameSize.height - this.image.height / 1.1, this.image.width / 1.1, this.image.height / 1.1);
