 ...
 */
/*
 оружие 3: баузка с доводчиком
 */

var Gun_3 = function(Game, Tower, Land) {
    this.game = Game;
    this.tower = Tower;
    this.land = Land;
    ...
    this.image1.src = "Images/Weapons/gun_3_1.png";
    this.image2 = new Image();
    this.image2.src = "Images/Weapons/gun_3_2.png";
...
// обновление
Gun_3.prototype.update = function(InputHandler, state) {
    switch (state) {
        case 1:
...
// рисунок
Gun_3.prototype.draw = function(screen) {
    if (this.tip) {
        screen.save();
        screen.shadowBlur=7;
        ...
        screen.fillText("Use LEFT and RIGHT buttons to control the bullet", this.game.gameSize.width / 2, this.game.gameSize.height - 5);
        screen.restore();
    }
    if (this.isBullet)
...
// выстрел
Gun_3.prototype.shoot = function(InputHandler) {
    ...
    if (this.shooting && !InputHandler.shoot) {
        ...
        this.bullet = new Bullet(this.tower.color, this.r, pos, V, 15, 2); // создали пулю
...
//удаление пули
Gun_3.prototype.delBullet = function() {
...
Gun_3.prototype.rotateP = function(Point) {
    var point = {
        x: Point.x,
        y: Point.y
    };
...
Gun_3.prototype.draw_gun = function(screen) {
